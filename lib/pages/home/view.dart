    ...
    return Scaffold(
      body: Stack(
        children: [
            ...
            onTap: (coordinates) {
              ...
              provider.isMarkerEnabled
                  ? provider.setMarker(
                      point: coordinates,
                      isOnTap: true,
                      useCustomMarker: provider.isDefaultMarker,
                    )
                  : null;
            },
          ),
          ...
          /// Navigation Direction From & To Text Fields & AutoComplete Results
      ...
      floatingActionButton: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            AnimatedContainer(
              height: 60,
              width: provider.expandSearchNavigation ? 260 : 60,
              duration: const Duration(milliseconds: 550),
              curve: Curves.linear,
              decoration: BoxDecoration(
                      ...
                      ? provider.isMarkerEnabled
                          ? ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                primary: ColorService.blue,
                              ),
                              child: Text(
                                provider.isDefaultMarker ? 'Default' : 'Custom',
                                style: const TextStyle(
                                  color: Colors.white,
                                  fontWeight: FontWeight.w700,
                                ),
